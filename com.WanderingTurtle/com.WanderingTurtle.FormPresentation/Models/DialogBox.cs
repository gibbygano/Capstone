...
namespace com.WanderingTurtle.FormPresentation.Models
{
    public static class DialogBox
    {
        ...
        public static Task<LoginDialogData> ShowLoginDialog(Control control, string title, string message = null, LoginDialogSettings settings = null)
        ...
        public static Task<MessageDialogResult> ShowMessageDialog(Control control, string title, string message = null, MessageDialogStyle? style = null, MetroDialogSettings settings = null)
