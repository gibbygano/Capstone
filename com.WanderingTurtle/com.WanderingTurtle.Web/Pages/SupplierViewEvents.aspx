...
<asp:Content ContentPlaceHolderID="MainContent" runat="server" ID="body">
    ...
    <div id="addListing" runat="server" style="display: none;">
        ...
        Start Date & Time:
        <input type="text" id="eventStart" name="startdate" class="mydate" />
        <br />
        End Date & Time
        <input type="text" id="eventEnd" name="enddate" class="mydate" />
        <br />
        Ticket Price: $
        <input id="listPrice" name="price" value="0.00" maxlength="6" class="myspinner">
        <br />
