...
namespace com.WanderingTurtle.BusinessLogic
{
    public static class Validator
    {
        ...
        /// <param name="max">maximum length</param>
        /// <returns>boolean value if string only contains allowed characters</returns>
        public static bool ValidateNumeric(this string inputToValidate, int minNumOfChars, int maxNumOfChars)
        {
            if (inputToValidate.Length >= minNumOfChars && inputToValidate.Length <= maxNumOfChars)
            {
                return Regex.IsMatch(inputToValidate, @"^[0-9]+$");
        ...
        /// <param name="inputToValidate">string to validate</param>
        /// <returns>boolean value if string only contains allowed characters</returns>
        public static bool ValidateAlphaNumeric(this string inputToValidate)
        {
        ...
        /// <param name="min">minimum length</param>
        /// <returns>boolean value if string only contains allowed characters</returns>
        public static bool ValidateAlphaNumeric(this string inputToValidate, int minNumOfChars)
        {
        ...
        /// <param name="max">maximum length</param>
        /// <returns>boolean value if string only contains allowed characters</returns>
        public static bool ValidateAlphaNumeric(this string inputToValidate, int minNumOfChars, int maxNumOfChars)
        {
            if (inputToValidate.Length >= minNumOfChars && inputToValidate.Length <= maxNumOfChars)
            {
                return Regex.IsMatch(inputToValidate, @"^['a-zA-Z0-9\s-]+$");
        ...
        public static bool ValidateInt(this string inputToValidate)
        {
            int num;
        ...
        /// <returns>boolean value if string is an int-- DOES NOT RETURN AN INT</returns>
        public static bool ValidateInt(this string inputToValidate, int min)
        {
            int num;
        ...
        /// <returns>boolean value if string is an int-- DOES NOT RETURN AN INT</returns>
        public static bool ValidateInt(this string inputToValidate, int min, int max)
        {
            int num;
            if (int.TryParse(inputToValidate, out num))
            {
        ...
        public static bool ValidateDouble(this string inputToValidate)
        {
            double num;
        ...
        /// <param name="min">minimum value</param>
        /// <returns>boolean value if string is a double-- DOES NOT RETURN A DOUBLE</returns>
        public static bool ValidateDouble(this string inputToValidate, double min)
        {
            double num;
        ...
        /// <param name="max">maximum value</param>
        /// <returns>boolean value if string is a double-- DOES NOT RETURN A DOUBLE</returns>
        public static bool ValidateDouble(this string inputToValidate, double min, double max)
        {
            double num;
            if (double.TryParse(inputToValidate, out num))
            {
        ...
        public static bool ValidateDecimal(this string inputToValidate)
        {
            decimal num;
        ...
        /// <param name="min">minimum value</param>
        /// <returns>boolean value if string is a decimal-- DOES NOT RETURN A DECIMAL</returns>
        public static bool ValidateDecimal(this string inputToValidate, decimal min)
        {
            decimal num;
        ...
        /// <param name="max">maximum value</param>
        /// <returns>boolean value if string is a decimal-- DOES NOT RETURN A DECIMAL</returns>
        public static bool ValidateDecimal(this string inputToValidate, decimal min, decimal max)
        {
            decimal num;
            if (decimal.TryParse(inputToValidate, out num))
            {
        ...
        public static bool ValidateDateTime(this string inputToValidate)
        {
            DateTime date;
        ...
        /// <returns>boolean value if string can be converted-- DOES NOT RETURN A DATETIME</returns>
        public static bool ValidateDateTime(this string inputToValidate, DateTime min)
        {
            DateTime date;
        ...
        /// <returns>boolean value if string can be converted-- DOES NOT RETURN A DATETIME</returns>
        public static bool ValidateDateTime(this string inputToValidate, DateTime min, DateTime max)
        {
            DateTime date;
            if (DateTime.TryParse(inputToValidate, out date))
            {
        ...
        public static bool ValidatePassword(this string inputToValidate)
        {
        ...
        public static bool ValidateBool(this string inputToValidate)
        {
            bool output;
        ...
        public static bool ValidatePhone(this string inputToValidate)
        {
        ...
        public static bool ValidateEmail(this string inputToValidate)
        {
            ...
            try
            {
                new MailAddress(inputToValidate);
                return true;
            }
            catch
            {
