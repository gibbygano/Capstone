...
(@hotelGuestID int)
AS
	SELECT Distinct BookingID, Booking.GuestID, EmployeeID, Booking.ItemListID, Booking.Quantity, DateBooked, Cancel, Refund, Booking.Active, ItemListing.Price,ItemListing.StartDate, EventItem.EventItemName
